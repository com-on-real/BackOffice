    ...
    <div class="col-md-6">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste des tickets ( Visible uniquement par les admins et quand tu clic dessus sa affiche une modal avec les info et la possiblité de rajouter un message) </h3>
